...
class UsersModel {
	 ...
	 * @return	boolean
	 */
 	public function userEdit( $userId, $userData)//this is clear that means - i undestand it!
 	{
	...
	public function listAllUsers()
	{
		...
		$sql = "SELECT * FROM users, roles WHERE users.id = " . $userid . " AND (roles.role='admin' OR roles.role='super_admin') AND roles.id=users.role_id LIMIT 1;";
																...
																// whoops....in the table roles are int 1,2,3, not string .....yeah we're searching the string
		...
		{
			// this bit is where you need to be changing and adding stuff. i can't finished it, because i ve never seen it before..
			...
			// within the users and roles tables...tables are before the . okay? THIS I KNOW IT.
			 ...
			 //i have read the previous week... let me show u... but how it is continuing in the cms...
	 ...
	 */
	public function getUserData( $userId )//this is clear that means - i undestand it!
